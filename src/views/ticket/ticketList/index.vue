<template>
  <div class="components-container">
    <div class="search-wrap">
      <el-form :inline="true" :model="searchData" class="demo-form-inline">
        <el-form-item class="add-btn">
          <el-button type="primary" icon="el-icon-plus" @click="handleAdd(false)">新增门票</el-button>
        </el-form-item>

        <el-form-item label="门票名称">
          <el-input v-model="searchData.name" placeholder="请输入门票名称"></el-input>
        </el-form-item>

        <el-form-item label="起止时间">
          <el-date-picker v-model="createdTime" :clearable="false" size="small" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" format="yyyy-MM-dd"></el-date-picker>
        </el-form-item>

        <el-form-item>
          <el-button type="primary" @click="searchDataSubmit" icon="el-icon-search">查询</el-button>
        </el-form-item>

        <el-form-item>
          <el-button plain @click="resetSearch" icon="el-icon-refresh-right">重置</el-button>
        </el-form-item>
      </el-form>
    </div>
    ...
    <!-- 编辑配置 -->
    <el-dialog :visible="dialogVisble" width="600px" class="int-app-modal" :title="isEdit ? '编辑菜单' : '新增菜单'" :before-close="closeDialog" :close-on-click-modal="false">
